...
class me_twomice_civicrm_aggregatehouseholdcontributions_FilterSet_Last extends me_twomice_civicrm_aggregatehouseholdcontributions_FilterSet {
  ...
  function _buildFilterCriteriaFields() {
    ...
    $this->_filter_criteria_fields['last_contribution_scope'] = array(
      ...
      'options'      => array(
        CIVIREPORT_AGGREGATE_HOUSEHOLD_FILTERSET_SCOPE_EVER => E::ts('Last contribution ever meets these criteria'),
        CIVIREPORT_AGGREGATE_HOUSEHOLD_FILTERSET_SCOPE_DATE_RANGE => E::ts('Last contribution meeting these criteria was within this date range'),
        CIVIREPORT_AGGREGATE_HOUSEHOLD_FILTERSET_SCOPE_AMOUNT_RANGE => E::ts('Last contribution meeting these criteria was within this amount range'),
      ),
